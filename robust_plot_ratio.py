...
train_lr = [0.651,0.701,0.723,0.753,0.754]

train_rf = [0.654,0.675,0.704,0.777,0.778]

train_svm = [0.596,0.609,0.663,0.751,0.760]

train_xgb = [0.670,0.689,0.679,0.749,0.758]
